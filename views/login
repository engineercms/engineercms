...
<div id="content" class="col-md-8 col-md-offset-2">
    ...
    <form method="POST" action="/post">
      ...
      <div class="form-group">
        ...
        <input id="uname" name="uname" type="text" value="admin" class="form-control" placeholder="Enter account" list="cars" onkeypress="getKey()"></div>
        <div id='datalistDiv'>
      ...
      <div class="form-group">
        ...
        <input id="pwd" name="pwd" type="password" value="admin" class="form-control" placeholder="Password" onkeypress="getKey()"></div>
      <div class="checkbox">
        <label>
